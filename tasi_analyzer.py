...
# 🛠️ [هنا الإصلاح الجذري] تم استبدال الرابط برابط جيت هاب السريع المباشر لضمان ظهور الصقر فوراً
...
FINANCIAL_DATA = {
    ...
    '2010': {'PE': 24.1, 'Sector': 'البتروكيماويات'}, '7010': {'PE': 15.1, 'الاتصالات': 'الاتصالات'},
